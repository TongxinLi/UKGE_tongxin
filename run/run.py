...
from UKGE_master_yuan.src.data import Data

from UKGE_master_yuan.src.trainer import Trainer
...
parser.add_argument('--batch_size', type=int, default=256, help="set batch size. default: 1024")
...
more_filt = [file_val, join(data_dir, 'test_with_neg.tsv')]
